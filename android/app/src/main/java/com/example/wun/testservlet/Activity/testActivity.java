...
import  com.example.wun.testservlet.Bean.Order.*;
...
public class testActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // LinearLayoutManager layoutManager1=new LinearLayoutManager(testActivity.this,LinearLayoutManager.VERTICAL,true);
        rlvAllOrder.setLayoutManager(new LinearLayoutManager(this));
        //rlvAllOrder.setLayoutManager(layoutManager1);
