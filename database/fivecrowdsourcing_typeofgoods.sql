...
CREATE TABLE `typeofgoods` (
  `tofgId` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) DEFAULT NULL,
  `delMethodId` int(11) DEFAULT NULL,
  PRIMARY KEY (`tofgId`),
  KEY `tofgId` (`tofgId`),
  KEY `checkdelMethodId` (`delMethodId`),
  CONSTRAINT `checkdelMethodId` FOREIGN KEY (`delMethodId`) REFERENCES `deliverymethod` (`delMethodId`) ON DELETE CASCADE ON UPDATE CASCADE
