...
public class validatedRunnerList extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public validatedRunnerList() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Runner> validatedRunners;
		if (session.getAttribute("validatedRunners") == null) {
			validatedRunners = new ArrayList<>();
			validatedRunners.add(runner);
			session.setAttribute("validatedRunners", validatedRunners);
		} else {
			validatedRunners = (ArrayList<Runner>) session
					.getAttribute("validatedRunners");
			validatedRunners.add(runner);
			session.setAttribute("validatedRunners", validatedRunners);
		}
